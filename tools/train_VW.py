...
def parse_args():
    ...
    parser.add_argument('--config', default="/home4/ssh/mmsegmentation-master/local_config/swin/vw_swin_base_480x480_160k_TIC.py", help='train config file path')
    parser.add_argument('--work-dir', default="/home4/ssh/result/VW_results/VW_TIC_160k/", help='the dir to save logs and models')
    parser.add_argument(
